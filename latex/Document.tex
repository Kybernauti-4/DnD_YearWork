...
DnD je stolní skupinová hra. Skupinová pouze proto, protože v jednom se tomu říká psaní knihy. Mezi hráči je jeden vypravěč a standardně více hráčů. Vypravěč si připraví příběh a svět, který svým hráčům bude přednášet a ve kterém je bude provádět. Když se začne hrát tak se v určitých momentech ptá hráčů, jak se chtějí zachovat, či co chtějí dělat. Po tom, co hráči zvolí, tak si hodí kostkou, aby zjistili jestli se jim daná akce povedla. Na základě tohoto výsledku vypravěč improvizací vytvoří novou část příběhu. Takto se celý příběh rozvíjí až snad někdy skončí.

Improvizace je ve světe DnD jedna z nejdůležitějších schopností. Bohužel počítače nejsou dobré v kreativitě. Tudíž, pokud jako programátoři chceme vytvořit hry s námětem DnD, musíme se velmi snažit. Já jsem rozhodl pro textově založenou hru, neboť má relativně jednoduché prostředí. Vím, že nejsem výborný programátor, a proto jsem věděl, že tvorba takové hry pro mě bude obtížná. Nakonec jsem se ustálil s tím, že vytvořím hru, která bude lehká hrát pro hráče a bude mít nástroje pro lehké tvoření příběhu pro vypravěče. Není to přesné vytvoření DnD, ale je to dobrý začátek, ze kterého se dá posunout dál.
...
\begin{figure}[H]
	...
	\centering
    \includegraphics[width=\textwidth-3 cm]{pictures/picoShineBoard.png}
    \caption{Konečný vzhled desky [vlastní]}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth-3 cm]{pictures/main_simple.drawio.png}
    \caption{Diagram hlavního programu [vlastní]}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth-3 cm]{pictures/handler.drawio.png}
    \caption{Diagram Handlera [vlastní]}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth-3 cm]{pictures/script_tool_1.png}
    \caption{Ukázka skriptovacího nástroje [vlastní]}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth-3 cm]{pictures/edit-choosing.png}
    \caption{Volení řádku [vlastní]}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth-3 cm]{pictures/edit-editing.png}
    \caption{Zvolený řádek [vlastní]}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth-3 cm]{pictures/register_better.png}
    \caption{Lepší zapojení sériového registru [vlastní]}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth-3 cm]{pictures/led_strip_better.png}
    \caption{Lepší zapojení LED stran [vlastní]}
\end{figure}

Celé schéma lepšího zapojení je v Příloze 2.
%\subsection{Problémy}
%\subsection{Budoucí řešení}
%\subsubsection{Hlavní program}
%\subsubsection{Skriptovací nástroj}

Kvůli počtu skriptů jsem se rozhodl, že je přiložím pouze na gitlab elektronicky.
\section{Zdroje}
\raggedright
Draw.io - free flowchart maker and diagrams online. \textit{Flowchart Maker Online Diagram Software} [online]. [Citováno~12~Dubna~2023]. Dostupné z: https://app.diagrams.net/

MicroPython documentation. \textit{Overview - MicroPython latest documentation} [online]. [Citováno~13~Dubna~2023]. Dostupné z: https://docs.micropython.org/en/latest/index.html 

Python tutorial [online]. [Citováno~12~Dubna~2023]. Dostupné z: https://www.w3schools.com/python/ 

Python tutorial - learn python programming. \textit{GeeksforGeeks} [online]. 3 Dubna 2023. [Citováno~13~Dubna~2023]. Dostupné z: https://www.geeksforgeeks.org/python-programming-language/

Python 3.11.3 documentation. \textit{3.11.3 Documentation} [online]. [Citováno~13~Dubna~2023]. Dostupné z: https://docs.python.org/3/ 

MICROSOFT. Visual studio code - code editing. redefined. \textit{RSS} [online]. 3 Listopadu 2021. [Citováno~13~Dubna~2023]. Dostupné z: https://code.visualstudio.com/ 


\section{Přílohy}
\begin{enumerate}
	\item \textbf{Příloha I: Zapojení klíče}
	\item \textbf{Příloha II: Lepší zapojení klíče}
  \end{enumerate}
\end{document}