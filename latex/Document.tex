...
Kolem souboru "storypart.json" už není další struktura velmi flexibilní. Na této úrovni očekává program nutné informace pro podávání informací. 
\begin{description}
	\item[Adresář texts] Pokud uživatel nechce do argumentů eventů vypisovat celý příběh, tak by zde měl existovat adresář texts, ve kterém jsou jednotlivé soubory .txt, které následně je schopen program číst.
\end{description}
...
Mezi další, již nepovinné, informace patří například listy pod klíči "lock" a "logic". První pole říká handlerovi aby hodnotu, kterou načetl z paměti nezahazoval a ponechal ji v paměti. Tato možnost by měla být použita pouze pro skripty u kterých víme že nebudou volány více než jednou. Nebo pokud víme že následně v eventech budou hodnoty násilně požrány. 
